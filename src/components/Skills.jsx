    ...
    <>
        <div name='skills'>
            ...
            <div className='md:max-w-[900px] sm:max-w-[600px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
                <div className=''>
                    <p className='text-2xl sm:text-4xl text-gray-600 font-semibold pb-2'>Skills</p>
                ...
                <div className='w-full grid grid-cols-2 md:grid-cols-5 gap-3 text-center py-2 sm:py-8'>
