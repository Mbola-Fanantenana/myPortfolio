...
import devL3 from '../assets/svg/dev1.svg'
import devL2 from '../assets/svg/dev2.svg'
    ...
    return (
        <div className='experiences'>
            ...
            <div className='md:max-w-[900px] sm:max-w-[600px] mx-auto p-4 flex flex-col justify-start w-full h-full'>
                <div>
                    <p className='pb-2 text-2xl font-semibold text-gray-600 sm:text-4xl'>Experiences</p>
                ...
                <div className='w-full text-center md:space-y-8'>
                    ...
                    <div className='grid-cols-2 gap-8 md:grid'>
                        <div className=''>
                            ...
                            <h3 className='p-4 font-semibold text-gray-600'>Web developer</h3>
