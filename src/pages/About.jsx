            ...
            <div className=''>
                <p className='text-gray-600 text-[14px] sm:text-[16px]'>
                    ...
                    <p className='pb-4 text-2xl font-semibold text-gray-600 sm:text-5xl'>
                        <Typed strings={[' Mbola Fanantenana', " a Junior web developer"]} typeSpeed={80} backSpeed={40} loop />
                    </p>
                    ...
                    <div>
                        <a href='https://drive.google.com/file/d/1VlfHmUWjpZmQ9mv8-SUygNk_cZNuxPYH/view?usp=drive_link' target='_blank' rel='noopener noreferrer'>
